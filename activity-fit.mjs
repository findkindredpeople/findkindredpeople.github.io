...
export function evaluateActivity(activity, limits) {
  ...
  if (minutes === null) questions.push('Confirm the session length and return travel time.');
  else if (minutes > limits.minutes) blockers.push(`${minutes - limits.minutes} minutes beyond your available time.`);
  if (cost === null) questions.push('Confirm the visit fee, materials and return transport cost.');
